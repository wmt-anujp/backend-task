...
<body>
    ...
    <div class="container mt-4">
        <h3 style="color: lightgreen;" class="my-4">Add Book</h3>
        <form method="POST" id="addbookform" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="isbn" name="isbn" maxlength="13" onkeypress="return (event.charCode > 48 && event.charCode < 58)" required>
            </div>
            <div class="mb-3">
